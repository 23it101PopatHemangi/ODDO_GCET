...
const DepartmentForm = () => {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-800">Department Form (Removed)</h1>
        <p className="text-gray-600 mt-1">Department create/edit functionality has been disabled.</p>
      </div>
